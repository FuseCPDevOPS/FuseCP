...
DELETE FROM "ServiceDefaultProperties" WHERE "ProviderID" IN (2, 3, 9, 11, 14, 28, 29, 60, 64, 65, 66, 91, 92, 101, 102, 105, 106, 300, 350, 351, 400, 1703, 1901);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260504130727_RemoveDeprecatedProviders', '9.0.9');

DELETE FROM "ServiceDefaultProperties" WHERE "ProviderID" IN (5, 16, 27, 32, 90, 202, 209, 1203, 1501);
