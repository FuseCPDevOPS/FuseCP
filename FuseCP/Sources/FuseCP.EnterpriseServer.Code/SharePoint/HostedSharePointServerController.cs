...
namespace FuseCP.EnterpriseServer.Code.SharePoint
{
    ...
    public class HostedSharePointServerController : ControllerBase, IImportController, IBackupController
    {
        ...
        public List<SharePointSiteCollection> GetSiteCollections(int organizationId)
        {
            ...
            return items.OfType<SharePointSiteCollection>().Where(siteCollection => siteCollection.OrganizationId == organizationId).ToList();
        }
        ...
        public List<string> GetImportableItems(int packageId, int itemTypeId, Type itemType, ResourceGroupInfo group)
        {
            ...
            {
                items.AddRange(hostedSharePointServer.GetSiteCollections().Select(siteCollection => siteCollection.Url));
            }
