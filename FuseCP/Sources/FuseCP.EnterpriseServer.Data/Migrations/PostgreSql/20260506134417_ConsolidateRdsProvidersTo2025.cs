...
namespace FuseCP.EnterpriseServer.Data.Migrations.PostgreSql
{
    ...
    public partial class ConsolidateRdsProvidersTo2025 : Migration
    {
        ...
        {
            migrationBuilder.Sql("UPDATE \"public\".\"Services\" SET \"ProviderID\" = 1505 WHERE \"ProviderID\" IN (1501, 1502, 1503, 1504);");

            migrationBuilder.Sql("DELETE FROM \"public\".\"Providers\" WHERE \"ProviderID\" = 1501;");
