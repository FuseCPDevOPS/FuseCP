...
WHERE sdp.""ProviderID"" IN (1301, 1552)
  AND NOT EXISTS (
      ...
      WHERE dst.""ProviderID"" = 1306 AND dst.""PropertyName"" = sdp.""PropertyName""
            ...
            migrationBuilder.Sql(@"DELETE FROM public.""ServiceDefaultProperties"" WHERE ""ProviderID"" IN (1301, 1552);");

            // Remap services to SharePoint Foundation 2016 (Provider 1306)
            migrationBuilder.Sql(@"UPDATE public.""Services"" SET ""ProviderID"" = 1306 WHERE ""ProviderID"" IN (1301, 1552);");
