...
namespace FuseCP.EnterpriseServer.Data.Migrations.Sqlite
{
    ...
    public partial class RemoveDeprecatedProviders : Migration
    {
        private static readonly int[] _deprecatedProviderIds =
            { 2, 3, 9, 11, 14, 28, 29, 60, 64, 65, 66, 91, 92, 101, 102, 105, 106, 300, 350, 351, 400, 1703, 1901 };

        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Delete ServiceDefaultProperties for these providers first to satisfy the FK constraint
            // (FK enforcement is ON at this point, set by RemovedLegacyStorefrontArtifacts migration).
