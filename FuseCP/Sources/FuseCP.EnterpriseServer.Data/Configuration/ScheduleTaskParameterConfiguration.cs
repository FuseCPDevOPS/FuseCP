...
public partial class ScheduleTaskParameterConfiguration: EntityTypeConfiguration<ScheduleTaskParameter>
{
    public override void Configure() {
        ...
        HasData(() => new ScheduleTaskParameter[] {
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CALCULATE_PACKAGES_BANDWIDTH", ParameterId = "SERVICE_CALL_ATTEMPTS", DataTypeId = "String", DefaultValue = "3", ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CALCULATE_PACKAGES_BANDWIDTH", ParameterId = "SERVICE_RETRY_DELAY_MS", DataTypeId = "String", DefaultValue = "250", ParameterOrder = 2 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CALCULATE_PACKAGES_DISKSPACE", ParameterId = "SERVICE_CALL_ATTEMPTS", DataTypeId = "String", DefaultValue = "3", ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CALCULATE_PACKAGES_DISKSPACE", ParameterId = "SERVICE_RETRY_DELAY_MS", DataTypeId = "String", DefaultValue = "250", ParameterOrder = 2 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "REQUEST_TIMEOUT_SECONDS", DataTypeId = "String", DefaultValue = "15", ParameterOrder = 11 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "REQUEST_ATTEMPTS", DataTypeId = "String", DefaultValue = "2", ParameterOrder = 12 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "REQUEST_RETRY_DELAY_MS", DataTypeId = "String", DefaultValue = "250", ParameterOrder = 13 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITES_SSL", ParameterId = "SSL_REQUEST_TIMEOUT_SECONDS", DataTypeId = "String", DefaultValue = "15", ParameterOrder = 12 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITES_SSL", ParameterId = "SSL_REQUEST_ATTEMPTS", DataTypeId = "String", DefaultValue = "2", ParameterOrder = 13 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITES_SSL", ParameterId = "SSL_REQUEST_RETRY_DELAY_MS", DataTypeId = "String", DefaultValue = "250", ParameterOrder = 14 },
        });
        #endregion
