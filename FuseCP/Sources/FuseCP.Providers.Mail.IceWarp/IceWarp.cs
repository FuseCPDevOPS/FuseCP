    ...
    public class IceWarp : HostingServiceProviderBase, IMailServer, IDisposable
    {
        ...
        protected MailList CreateMailListFromAccountObject(dynamic accountObject)
        {
            ...
            var mailList = new MailList
            {
                ...
                MembersSource = Enum.Parse(typeof(IceWarpListMembersSource), (accountObject.GetProperty("M_SendAllLists")).ToString()),
                ...
                Originator = Enum.Parse(typeof(IceWarpListOriginator), (accountObject.GetProperty("M_ListSender")).ToString()),
                ...
                PasswordProtection = Enum.Parse(typeof(PasswordProtection), (accountObject.GetProperty("M_Moderated")).ToString()),
                Password = accountObject.GetProperty("M_ModeratedPassword"),
                DefaultRights = Enum.Parse(typeof(IceWarpListDefaultRights), (accountObject.GetProperty("M_DefaultRights")).ToString()),
                ...
                ConfirmSubscription = Enum.Parse(typeof(IceWarpListConfirmSubscription), (listServerAccountObject.GetProperty("L_DigestConfirmed")).ToString()),
