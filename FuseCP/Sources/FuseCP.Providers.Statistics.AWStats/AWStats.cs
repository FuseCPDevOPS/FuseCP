...
namespace FuseCP.Providers.Statistics
{
    ...
    public class AWStats : HostingServiceProviderBase, IStatisticsServer
    {
        ...
        public virtual string[] GetSites()
        {
            ...
            foreach (string site in files
                .Select(file => Path.GetFileName(file))
                .Select(fileName => fileName.Substring(configPrefix.Length,
        ...
        public virtual StatsSite GetSite(string siteId)
        {
            ...
            string configFilePath = Path.Join(AwStatsFolder, configFileName.TrimStart(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar));
        ...
        public virtual string AddSite(StatsSite site)
        {
                ...
                string configFilePath = Path.Join(awFolder, configFileName.TrimStart(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar));
                ...
                string batchFilePath = Path.Join(awFolder, BatchFileName.TrimStart(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar));
        ...
        public virtual void DeleteSite(string siteId)
        {
            ...
            string batchFilePath = Path.Join(AwStatsFolder, BatchFileName.TrimStart(Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar));
