	...
	<asp:GridView id="gvPlans" runat="server"  EnableViewState="true" AutoGenerateColumns="false"
	 EmptyDataText="gvPlans" CssSelectorClass="NormalGridView" OnRowCommand="gvPlan_RowCommand" >
		<Columns>
			...
			<asp:TemplateField>
				<ItemTemplate>
                        <asp:LinkButton id="btnStamp" CssClass="btn btn-warning" runat="server" CommandName="RestampItem" CommandArgument='<%# Eval("LyncUserPlanId") %>' OnClientClick="if (confirm('Restamp lync user with this plan.\n\nAre you sure you want to restamp the lync users ?')) ShowProgressDialog('Stamping lync users, this might take a while ...'); else return false;"> <i class="bi bi-copy me-1"></i><asp:Localize runat="server" meta:resourcekey="btnStampText"/> </asp:LinkButton>
				</ItemTemplate>
			</asp:TemplateField>
		</Columns>
	</asp:GridView>
        ...
        <tr>
            <td>
                <div class="FormButtonsBarClean">
                        <asp:LinkButton id="btnUpdatePlan" CssClass="btn btn-warning" runat="server" OnClick="btnUpdatePlan_Click"> <i class="bi bi-arrow-clockwise me-1"></i><asp:Localize runat="server" meta:resourcekey="btnUpdatePlanText"/> </asp:LinkButton>&nbsp;
                    <asp:LinkButton id="btnAddPlan" CssClass="btn btn-success" runat="server" OnClick="btnAddPlan_Click"> <i class="bi bi-file-earmark-text me-1"></i><asp:Localize runat="server" meta:resourcekey="btnAddPlanText"/> </asp:LinkButton>
                </div>
            </td>
        </tr>
    </table>
