...
namespace FuseCP.Portal.RDS.UserControls
{
    public partial class RDSCollectionUsers : FuseCPControlBase
	{
        ...
        protected void BindAccounts(OrganizationUser[] newUsers, bool preserveExisting)
		{
            ...
            if (newUsers != null)
			{
                users.AddRange(newUsers.Where(newUser => !users.Any(user => String.Compare(user.AccountName, newUser.AccountName, true) == 0)));
			}
        ...
        protected void gvUsers_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(EditUrl("SpaceID", PanelSecurity.PackageId.ToString(), "rds_setup_letter", "CollectionID=" + PanelRequest.CollectionID, "ItemID=" + PanelRequest.ItemID, "AccountID=" + e.CommandArgument));
            }
        }
	}
}
