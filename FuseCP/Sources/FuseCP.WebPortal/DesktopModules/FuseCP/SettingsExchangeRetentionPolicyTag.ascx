        ...
        <tr>
            <td>
                <div class="FormButtonsBarClean">
                    <asp:LinkButton id="btnUpdatePolicy" CssClass="btn btn-warning" runat="server" OnClick="btnUpdatePolicy_Click"> <i class="bi bi-arrow-clockwise me-1"></i><asp:Localize runat="server" meta:resourcekey="btnUpdatePolicyText"/> </asp:LinkButton>&nbsp;
                    <asp:LinkButton id="btnAddPolicy" CssClass="btn btn-success" runat="server" OnClick="btnAddPolicy_Click"> <i class="bi bi-file-earmark-text me-1"></i><asp:Localize runat="server" meta:resourcekey="btnAddPolicyText"/> </asp:LinkButton>
                </div>
            </td>
        </tr>
    </table>
