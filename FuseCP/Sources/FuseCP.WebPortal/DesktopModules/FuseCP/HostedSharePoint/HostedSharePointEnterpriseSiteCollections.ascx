				...
				<div class="card-body form-horizontal">
					...
					<div class="FormButtonsBarClean">
						<div class="FormButtonsBarCleanLeft">
							<asp:LinkButton id="btnCreateSiteCollection" CssClass="btn btn-primary" runat="server" OnClick="btnCreateSiteCollection_Click"> <i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnCreateSiteCollectionText"/> </asp:LinkButton>
						</div>
