...
<div class="card-footer text-end">
    ...
    <asp:LinkButton id="btnBackup" CssClass="btn btn-success" runat="server" OnClick="btnBackup_Click" ValidationGroup="Backup"> <i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnBackup"/> </asp:LinkButton>
</div>
