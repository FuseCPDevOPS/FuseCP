		    ...
		    <div class="Center">
			    <div class="card-body form-horizontal">
                    ...
                    <p>
                        ...
                        <asp:LinkButton id="btnMove" CssClass="btn btn-success" runat="server" OnClick="btnMove_Click" ValidationGroup="MoveWizard"> <i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnMoveText"/> </asp:LinkButton>
                    </p>
