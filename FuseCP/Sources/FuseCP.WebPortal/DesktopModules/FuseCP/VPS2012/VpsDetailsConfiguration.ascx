	    ...
	    <div class="Content">
		    <div class="Center">
			    <div class="card-body form-horizontal">
                    ...
                    <div class="text-end">
                        <asp:LinkButton id="btnEdit" CssClass="btn btn-success" runat="server" OnClick="btnEdit_Click" CausesValidation="false"> <i class="bi bi-pencil me-1"></i><asp:Localize runat="server" meta:resourcekey="btnEditText"/> </asp:LinkButton>
                    </div>
