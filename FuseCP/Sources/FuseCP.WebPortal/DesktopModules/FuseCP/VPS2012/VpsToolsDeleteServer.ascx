		    ...
		    <div class="Center">
			    <div class="card-body form-horizontal">
                    ...
                    <div class="text-end">
                        ...
                        <asp:LinkButton id="btnDelete" CssClass="btn btn-danger" runat="server" OnClick="btnDelete_Click" ValidationGroup="Tools"> <i class="bi bi-trash me-1"></i><asp:Localize runat="server" meta:resourcekey="btnDeleteText"/> </asp:LinkButton>
                    </div>
			    </div>
		    </div>
	    </div>
