...
<asp:UpdatePanel ID="RecordsUpdatePanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
	...
	<div class="FormButtonsBar right fcp-domain-records-action-offset">
						<asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" CausesValidation="False"> <i class="bi bi-plus-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnAdd"/> </asp:LinkButton>
	</div>
		...
		<asp:Panel ID="EditRecordPanel" runat="server" style="display:none">
			...
			<asp:UpdatePanel ID="EditRecordUpdatePanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
				<ContentTemplate>
                    ...
                    <asp:LinkButton id="btnSave" CssClass="btn btn-success" runat="server" OnClick="btnSave_Click" ValidationGroup="DnsZoneRecord"> <i class="bi bi-floppy me-1"></i><asp:Localize runat="server" meta:resourcekey="btnSave"/> </asp:LinkButton>
                    </div>
            </div>
       </asp:Panel>
