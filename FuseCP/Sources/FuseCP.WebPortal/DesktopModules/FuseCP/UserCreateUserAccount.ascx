...
<asp:Panel ID="UserCreatUserAccountPanel" runat="server" DefaultButton="btnCreate">
    ...
    <div class="card-footer text-end">
        ...
        &nbsp;
        <asp:LinkButton ID="btnCreate" CssClass="btn btn-success" runat="server" OnClick="btnCreate_Click"><i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnCreate" />
        </asp:LinkButton>
    </div>
</asp:Panel>
