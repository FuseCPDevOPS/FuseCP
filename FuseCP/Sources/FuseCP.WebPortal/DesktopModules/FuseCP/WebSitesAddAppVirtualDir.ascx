...
<div class="card-footer text-end">
    ...
    <asp:LinkButton ID="btnAdd" CssClass="btn btn-success" runat="server" OnClick="btnAdd_Click"><i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="btnAddApp" />
    </asp:LinkButton>
    &nbsp;
</div>
