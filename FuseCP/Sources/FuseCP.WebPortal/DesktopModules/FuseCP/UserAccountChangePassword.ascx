...
<asp:Panel ID="PasswordPanel" runat="server" DefaultButton="cmdChangePassword">
    ...
    <div class="card-footer text-end">
        ...
        <asp:LinkButton id="cmdChangePassword" CssClass="btn btn-success" runat="server" OnClick="cmdChangePassword_Click" ValidationGroup="NewPassword"> <i class="bi bi-check-lg me-1"></i><asp:Localize runat="server" meta:resourcekey="cmdChangePassword"/> </asp:LinkButton>
    </div>
</asp:Panel>
