	...
	public partial class DomainsAddDomain : FuseCPModuleBase
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			{ 
				...
				if ((PanelSecurity.LoggedUser.Role == UserRole.User) && (type != DomainType.SubDomain && !PackagesHelper.CheckGroupQuotaEnabled(PanelSecurity.PackageId, ResourceGroups.Dns, Quotas.DNS_EDITOR)))
				{
